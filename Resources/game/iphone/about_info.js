...
function buildAboutInfo(infoType){
	...
	if(shouldCreateView){
		...
		if(infoType == ABOUT_PAGE_HOWTO){
			aboutTableInfoData.push(buildAboutInfoTableRow(1, 'Επιλέγεις μια από τις 11 κατηγορίες γνώσεων για να παίξεις.\n\n'));
		...
		aboutInfoTableHeader = Ti.UI.createLabel({
			...
			left:15,
			top:IPHONE5 ? 112 : 120,
			font:{fontSize:22, fontWeight:'bold', fontFamily:'321impact'}
		});
