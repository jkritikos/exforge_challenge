...
viewLoader.addEventListener('loaderStart', function(data){
    ...
    var loadEvent = function(){
    	...
    	//trelo workaround...
    	Ti.API.info('Loader: restartingGame='+restartingGame+' and gameSession.shouldRestartWithNewCategory()='+gameSession.shouldRestartWithNewCategory());
