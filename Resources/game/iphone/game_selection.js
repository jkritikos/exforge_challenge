...
var GAME_SELECTION_IPHONE5_OFFSET_HEIGHT = 10;
...
function buildGameSelectionView(){
	...
	if(shouldCreateView){
		...
		gameSelectionTableView = Titanium.UI.createTableView({
			minRowHeight:IPHONE5? 220 : 180,
			data:populateGameSelectionTable(),
			backgroundColor:'transparent',
			separatorStyle:Ti.UI.iPhone.TableViewSeparatorStyle.NONE,
			top:IPHONE5? 115+GAME_SELECTION_IPHONE5_OFFSET_HEIGHT:100,
			bottom:IPHONE5? 0:10
		});
...
function populateGameSelectionTable(){
	...
	var bgImage = Titanium.UI.createImageView({
		image:IPHONE5? IMAGE_PATH+'game_selection/solo-568h.png' : IMAGE_PATH+'game_selection/Solo.png'
	});
	...
	var bgImage2 = Titanium.UI.createImageView({
		image:IPHONE5? IMAGE_PATH+'game_selection/group-568h.png' : IMAGE_PATH+'game_selection/Group.png'
	});
