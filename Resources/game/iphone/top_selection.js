...
var TOP_SELECTION_IPHONE5_OFFSET_HEIGHT = 40;
...
function buildTopSelectionView(){
	...
	if(shouldCreateView){
		...
		labelTopSelection = Titanium.UI.createLabel({
			text:'Δες τα top scores σε Solo και Group!',
			color:'white',
			left:15,
			top:IPHONE5? 98+TOP_SELECTION_IPHONE5_OFFSET_HEIGHT : 120,
			//width:'auto',
			//height:'auto',
			shadowColor:'#000000',
		...
		topSelectionTableView = Titanium.UI.createTableView({
			...
			top:IPHONE5? 150+TOP_SELECTION_IPHONE5_OFFSET_HEIGHT : 150,
			bottom:0
		});
