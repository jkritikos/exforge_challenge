...
var GROUP_SELECTION_IPHONE5_OFFSET_HEIGHT = 50;
...
function buildGroupSelectionView(){
	...
	if(shouldCreateView){
		...
		groupSelectionBottomFader = Ti.UI.createImageView({
			image:IPHONE5? IMAGE_PATH+'group_selection/blackscreen-568h.png' : IMAGE_PATH+'group_selection/black_screen1.png',
			bottom:IPHONE5? 0 : 0,
			zIndex:5
		});
		...
		groupSelectionTopFader = Ti.UI.createImageView({
			image:IPHONE5? IMAGE_PATH+'group_selection/blackscreen-568h.png' : IMAGE_PATH+'group_selection/black_screen2.png',
			top:IPHONE5? 56 : 0,
			zIndex:5,
			visible:false
		});
		...
		groupPlayersImageView = Ti.UI.createImageView({
			image:IPHONE5? IMAGE_PATH+'group_selection/players-568h.png' : IMAGE_PATH+'group_selection/players.png',
			top:IPHONE5? 105 : 95,
			left:0,
			groupType:1	
		});
		...
		groupPlayersTitleLabel = Ti.UI.createLabel({
			...
			textAlign:'center',
			top:IPHONE5? 40:28,
			width:IPHONE5? 145:100,
			height:80,
			zIndex:2,
			groupType:1,
			font:{fontSize:IPHONE5? 32:25, fontWeight:'bold', fontFamily:'321impact'}
		});
		
		groupPlayersDescLabel = Ti.UI.createLabel({
			text:IPHONE5? 'Κάθε παίκτης \nμόνος εναντίον \nτων άλλων!' : 'Κάθε παίκτης μόνος του εναντίον των άλλων!',
			textAlign:'center',
			top:IPHONE5? 105:80,
			width:IPHONE5? 150:120,
			height:60,
			zIndex:2,
			groupType:1,
			shadowColor:'#000000',
			shadowOffset:{x:1,y:1},
			font:{fontSize:IPHONE5? 16:12, fontWeight:'regular', fontFamily:'Myriad Pro'}
		});
		...
		groupTeamsImageView = Ti.UI.createImageView({
			image:IPHONE5? IMAGE_PATH+'group_selection/teams-568h.png' : IMAGE_PATH+'group_selection/teams.png',
			top:IPHONE5? 105 : 95,
			right:0,
			groupType:2
		});
		...
		groupTeamsDescLabel = Ti.UI.createLabel({
			text:IPHONE5? 'Η απόλυτη \nομαδική \nαναμέτρηση!' : 'Η απόλυτη ομαδική αναμέτρηση!',
			textAlign:'center',
			top:IPHONE5? 105:80,
			width:IPHONE5? 150:120,
			height:60,
		...
		groupSelectionTopBanner2 = Ti.UI.createView({
			...
			height:50,
			zIndex:6,
			top:IPHONE5? 260+GROUP_SELECTION_IPHONE5_OFFSET_HEIGHT : 260
		});
		
		groupSelectionBannerLabel2 = Ti.UI.createLabel({
			text:'Θέλετε να παίζετε εναλλάξ ή χαλαρά?',
			color:'white',
			textAlign:'center',
			height:23,
			top:17,
		...
		groupSwitchImageView = Ti.UI.createImageView({
			image:IPHONE5? IMAGE_PATH+'group_selection/switch-568h.png' : IMAGE_PATH+'group_selection/switch.png',
			top:IPHONE5? 310+GROUP_SELECTION_IPHONE5_OFFSET_HEIGHT : 310,
			left:0,
			turnType:1
		});
		...
		groupSwitchDescLabel = Ti.UI.createLabel({
			text:IPHONE5? 'Εναλλαγή \nπαίκτη σε \nκάθε ερώτηση!' : 'Εναλλαγή παίκτη σε κάθε ερώτηση!',
			textAlign:'center',
			top:IPHONE5? 105:80,
			width:IPHONE5? 150:120,
			height:60,
		...
		groupChillImageView = Ti.UI.createImageView({
			image:IPHONE5? IMAGE_PATH+'group_selection/chill-568h.png' : IMAGE_PATH+'group_selection/chill.png',
			top:IPHONE5? 310+50 : 310,
			right:0,
			turnType:2
		});
		...
		groupChillDescLabel = Ti.UI.createLabel({
			text:IPHONE5? 'Πασάρεις \nμόλις χάσεις \nτην παρτίδα!' : 'Πασάρεις μόλις χάσεις την παρτίδα!',
			textAlign:'center',
			top:IPHONE5? 105:80,
			width:IPHONE5? 150:120,
			height:60,
