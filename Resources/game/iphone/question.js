...
function buildQuestionView(defaultQuestionBanner){
	...
	if(shouldCreateView){
		...
		//////////////////////////////////////Game over
		var GROUP_PLAY_GAMEOVER_HEIGHT_OFFSET = 40;
		...
		if(gameSession.getGameType() == BUZZ_GAME_GROUP){
			gameOverTopScoreLabel = Titanium.UI.createLabel({
				...
				top:32,
				height:80,
				font:{fontSize:32, fontWeight:'regular', fontFamily:'321impact'},
				zIndex:10
			});
		...
		gameOverQuestionStats = Titanium.UI.createLabel({
			text:'12/23 ερωτήσεις',
			color:'white',
			shadowColor:'#000000',
			textAlign:'center',
		    shadowOffset:{x:1,y:1},
		    zIndex:10,
		    top:gameSession.getGameType() == BUZZ_GAME_GROUP ? (100+GROUP_PLAY_GAMEOVER_HEIGHT_OFFSET) : 100,
		    left:7,
		    right:7,
			font:{fontSize:20, fontWeight:'bold', fontFamily:'Myriad Pro'}
		});
		...
		gameOverScoreLabelValue = Titanium.UI.createLabel({
			text:'0',
			color:'#fee902',
			top:gameSession.getGameType() == BUZZ_GAME_GROUP ? (53+GROUP_PLAY_GAMEOVER_HEIGHT_OFFSET) : 53,
			height:60,
			font:{fontSize:42, fontWeight:'regular', fontFamily:'321impact'},
			zIndex:10
		});
		...
		//////////////////////////////////////End game over
		barImages.push(IMAGE_PATH+'timer/full.png');
		barImages.push(IMAGE_PATH+'timer/full_01.png');
		barImages.push(IMAGE_PATH+'timer/full_02.png');
		barImages.push(IMAGE_PATH+'timer/full_03.png');
		barImages.push(IMAGE_PATH+'timer/full_04.png');
		barImages.push(IMAGE_PATH+'timer/full_05.png');
		barImages.push(IMAGE_PATH+'timer/full_06.png');
		barImages.push(IMAGE_PATH+'timer/full_07.png');
		barImages.push(IMAGE_PATH+'timer/full_08.png');
		barImages.push(IMAGE_PATH+'timer/full_09.png');
		barImages.push(IMAGE_PATH+'timer/full_10.png');
		barImages.push(IMAGE_PATH+'timer/full_11.png');
		barImages.push(IMAGE_PATH+'timer/full_12.png');
		barImages.push(IMAGE_PATH+'timer/full_13.png');
		barImages.push(IMAGE_PATH+'timer/full_14.png');
		barImages.push(IMAGE_PATH+'timer/full_15.png');
		barImages.push(IMAGE_PATH+'timer/full_16.png');
		barImages.push(IMAGE_PATH+'timer/full_17.png');
		barImages.push(IMAGE_PATH+'timer/full_18.png');
		barImages.push(IMAGE_PATH+'timer/full_19.png');
		barImages.push(IMAGE_PATH+'timer/full_20.png');
		barImages.push(IMAGE_PATH+'timer/full_21.png');
		barImages.push(IMAGE_PATH+'timer/full_22.png');
		barImages.push(IMAGE_PATH+'timer/full_23.png');
		barImages.push(IMAGE_PATH+'timer/full_24.png');
		barImages.push(IMAGE_PATH+'timer/full_25.png');
		barImages.push(IMAGE_PATH+'timer/full_26.png');
		barImages.push(IMAGE_PATH+'timer/full_27.png');
		barImages.push(IMAGE_PATH+'timer/full_28.png');
		barImages.push(IMAGE_PATH+'timer/full_29.png');
		barImages.push(IMAGE_PATH+'timer/full_30.png');
		barImages.push(IMAGE_PATH+'timer/full_31.png');
		barImages.push(IMAGE_PATH+'timer/full_32.png');
		barImages.push(IMAGE_PATH+'timer/full_33.png');
		barImages.push(IMAGE_PATH+'timer/full_34.png');
		barImages.push(IMAGE_PATH+'timer/full_35.png');
		barImages.push(IMAGE_PATH+'timer/full_36.png');
		barImages.push(IMAGE_PATH+'timer/full_37.png');
		barImages.push(IMAGE_PATH+'timer/full_38.png');
		barImages.push(IMAGE_PATH+'timer/full_39.png');
		barImages.push(IMAGE_PATH+'timer/full_40.png');
		barImages.push(IMAGE_PATH+'timer/full_41.png');
		barImages.push(IMAGE_PATH+'timer/full_42.png');
		barImages.push(IMAGE_PATH+'timer/full_43.png');
		barImages.push(IMAGE_PATH+'timer/full_44.png');
		barImages.push(IMAGE_PATH+'timer/full_45.png');
		barImages.push(IMAGE_PATH+'timer/full_46.png');
		barImages.push(IMAGE_PATH+'timer/full_47.png');
		barImages.push(IMAGE_PATH+'timer/full_48.png');
		barImages.push(IMAGE_PATH+'timer/full_49.png');
		barImages.push(IMAGE_PATH+'timer/full_50.png');
		barImages.push(IMAGE_PATH+'timer/full_51.png');
		barImages.push(IMAGE_PATH+'timer/full_52.png');
		barImages.push(IMAGE_PATH+'timer/full_53.png');
		barImages.push(IMAGE_PATH+'timer/full_54.png');
		barImages.push(IMAGE_PATH+'timer/full_55.png');
		barImages.push(IMAGE_PATH+'timer/full_56.png');
		barImages.push(IMAGE_PATH+'timer/full_57.png');
		barImages.push(IMAGE_PATH+'timer/full_58.png');
		barImages.push(IMAGE_PATH+'timer/full_59.png');
		barImages.push(IMAGE_PATH+'timer/full_60.png');
		barImages.push(IMAGE_PATH+'timer/full_60.png');
		barImages.push(IMAGE_PATH+'timer/full_61.png');
		barImages.push(IMAGE_PATH+'timer/full_62.png');
		barImages.push(IMAGE_PATH+'timer/full_63.png');
		barImages.push(IMAGE_PATH+'timer/full_64.png');
		barImages.push(IMAGE_PATH+'timer/full_65.png');
		barImages.push(IMAGE_PATH+'timer/full_66.png');
		barImages.push(IMAGE_PATH+'timer/full_67.png');
		barImages.push(IMAGE_PATH+'timer/full_68.png');
		barImages.push(IMAGE_PATH+'timer/full_69.png');
		barImages.push(IMAGE_PATH+'timer/full_70.png');
		barImages.push(IMAGE_PATH+'timer/full_71.png');
		barImages.push(IMAGE_PATH+'timer/full_72.png');
		barImages.push(IMAGE_PATH+'timer/full_73.png');
		barImages.push(IMAGE_PATH+'timer/full_74.png');
		barImages.push(IMAGE_PATH+'timer/full_75.png');
		barImages.push(IMAGE_PATH+'timer/full_76.png');
		barImages.push(IMAGE_PATH+'timer/full_77.png');
		barImages.push(IMAGE_PATH+'timer/full_78.png');
		barImages.push(IMAGE_PATH+'timer/full_79.png');
		barImages.push(IMAGE_PATH+'timer/full_80.png');
