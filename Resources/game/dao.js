...
var BADGE1_LABEL = 'Τρελός Επιστήμονας';
var BADGE1_DESCRIPTION = 'Γίνε \"Τρελός Επιστήμονας\" κερδίζοντας όσους περισσότερους πόντους μπορείς στην κατηγορία Επιστήμη!';

var BADGE2_LABEL = 'Γητευτής των Όσκαρ';
var BADGE2_DESCRIPTION = 'Γίνε \"Γητευτής των Όσκαρ\" κερδίζοντας όσους περισσότερους πόντους μπορείς στην κατηγορία Κινηματογράφος!';

var BADGE3_LABEL = 'Πειρατής του Κόσμου';
var BADGE3_DESCRIPTION = 'Γίνε \"Πειρατής του Κόσμου\" κερδίζοντας όσους περισσότερους πόντους μπορείς στην κατηγορία Γεωγραφία!';

var BADGE4_LABEL = 'Γεννημένος Αθλητής';
var BADGE4_DESCRIPTION = 'Γίνε \"Γεννημένος Αθλητής\" κερδίζοντας όσους περισσότερους πόντους μπορείς στην κατηγορία Αθλητικά!';

var BADGE5_LABEL = 'Ψηφιακός Σπασίκλας';
var BADGE5_DESCRIPTION = 'Γίνε \"Ψηφιακός Σπασίκλας\" κερδίζοντας όσους περισσότερους πόντους μπορείς στην κατηγορία Τεχνολογία!';
