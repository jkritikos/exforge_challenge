...
var inviteFriendsGenericLabel = null;
...
function buildInviteFriendsPopup(){
	...
	inviteFriendsBackgroundImage = Ti.UI.createImageView({
		image:IMAGE_PATH+'top/invite_bg.png' ,
	...
	inviteFriendsGenericLabel = Ti.UI.createLabel({
		text:'Με ποιόν τρόπο θέλεις \nνα τους καλέσεις?',
		color:'white',
		textAlign:'center',
	...
	inviteFriendsBackgroundImage.add(inviteFriendsGenericLabel);
	...
	inviteFriendsFacebookBackgroundImage = Ti.UI.createImageView({
		image:IMAGE_PATH+'invite/invite_fb_bg.png' ,
		visible:false,
		zIndex:10
	});
...
function destroyInviteFriendsPopup(){
	...
	inviteFriendsBackgroundImage.remove(inviteFriendsGenericLabel);
	...
	inviteFriendsGenericLabel = null;
